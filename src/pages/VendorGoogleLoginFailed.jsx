...
const VendorGoogleLoginFailed = () => {
    const account=database.account;

    const handleGoogleSignIn = () => {
      account.createOAuth2Session("google", "http://localhost:3000/vendor/loginRedirect", "http://localhost:3000/vendor/googleLoginFailed")
...
export default VendorGoogleLoginFailed;
